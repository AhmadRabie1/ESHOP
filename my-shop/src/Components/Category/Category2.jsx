    ...
    <div className="py-8">
      <div className="container">
        <div className="grid grid-cols-1 sm:placeholder:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/*third col */}
          <div className="py-10 pl-5 bg-gradient-to-br from-brandBlue to-brandBlue/70 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
                <p className="mb-[2px] text-white">Enjoy</p>
                <p className="text-2xl font-semibold mb[2px]">With</p>
            ...
            <img src={Image3} alt="" className="w-[180px] absolute bottom-0 right-0 lg:top-[140px]" />
          </div>
